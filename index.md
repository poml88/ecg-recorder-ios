...
The open source software [EDFbrowser](https://www.teuniz.net/edfbrowser) can convert the ascii text files into .edf files which can be nicely browsed using the software. Some sample ECG data and demo videos for import into Apple Numbers and EDFBrowser are available at the Github site (https://github.com/poml88/ecg-recorder-ios).
